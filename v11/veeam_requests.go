...
type RequestData struct {
	XMLName xml.Name    `xml:"FIData"`
	FISpec  interface{} `xml:"FISpec"`
}

type RequestSpec struct {
	FIScope     int    `xml:"FIScope,attr"`
	FIMethod    int    `xml:"FIMethod,attr"`
	FISessionID string `xml:"FISessionID,attr"`
}
